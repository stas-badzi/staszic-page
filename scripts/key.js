...
const MAX_NR_OF_USER_KEYMAPS = 256; /* should be at least 7 */


const MAX_NR_FUNC = 256; /* max nr of strings assigned to keys */

const KT_LATIN = 0; /* we depend on this being zero */
const KT_FN = 1;
const KT_SPEC = 2;
const KT_PAD = 3;
const KT_DEAD = 4;
...
const KT_ASCII = 9;
const KT_LOCK = 10;
const KT_LETTER = 11; /* symbol that can be acted upon by CapsLock */
const KT_SLOCK = 12;
const KT_DEAD2 = 13;
const KT_BRL = 14;
...
const K_PGUP = (((KT_FN)<<8)|24); /* PGUP is a synonym for PRIOR */
const K_PGDN = (((KT_FN)<<8)|25); /* PGDN is a synonym for NEXT */
...
const K_ALLOCATED = (((KT_SPEC)<<8)|126); /* dynamically allocated keymap */
const K_NOSUCHMAP = (((KT_SPEC)<<8)|127); /* returned by KDGKBENT */
